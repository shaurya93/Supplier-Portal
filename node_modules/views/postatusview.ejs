			...
			<div class="card-1" style="background-color:white; overflow:scroll;">
				<table id="" class="ex1" cellspacing="0" width="100%">
					<tr>
							...
							<td style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="https://nodeappt.herokuapp.com/refresh?record_type=PurchaseOrder&po_status=<%= statuspo%>">Refresh</a></td>
					</tr>
				</table>
