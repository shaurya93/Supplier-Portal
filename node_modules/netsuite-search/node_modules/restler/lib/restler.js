...
mixin(Request.prototype, {
  ...
  run: function() {
	  ...
	  console.log("Multipart Function"+this.options.multipart);
    var self = this;
    if (this.options.multipart) {
      multipart.write(this.request, this.options.data, function() {
	      console.log("Multipart Function Before Self request"+this.options.multipart);
        self.request.end();
	      console.log("Multipart Function after self request"+this.options.multipart);
      });
    } else {
	    console.log('Inside else');
      if (this.options.data) {
        this.request.write(this.options.data.toString(), this.options.encoding || 'utf8');
	      console.log('Inside else - if'+this);
      }
      this.request.end();
    }
   console.log('Before Exit Run'+this);
    return this;
  },
  abort: function(err) {
    var self = this;
...
function request(url, options) {
 ...
 console.log("Inside REquest Function"+request);
...
function post(url, options) {
     console.log('Inside Post'+JSON.stringify(request(url, shortcutOptions(options, 'POST'))));
