...
console.log('server file update 2nd  ==> '+server);
console.log('After Server in setsuite-search lib file please show me  ==> ');  
//var CryptoJS = require("crypto-js");
var CryptoJS = require('crypto-js/hmac-sha1.js');
console.log('CryptoJS  in netsuite-search file 1 sha1 ==> '+CryptoJS);  
var CryptoJS = require('crypto-js/hmac-sha256.js');
var CryptoJS = require('crypto-js/enc-based64-min.js');
console.log('CryptoJS  in netsuite-search file ==> '+CryptoJS);  
var OAuth   = require('oauth-1.0a');
console.log('OAuth  in netsuite-search file  ==> '+OAuth);  
