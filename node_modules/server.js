...
var rest_params = {event:"login",email:req.body.your_email,password:req.body.your_password,vendor_id:"1413"};
 ...
 var contents='';		
			...
			if(results.status=='Successful')
			{
				...
				vendorid=results.vendor_id;
				 contents = db.exec("select * from vendor_master where vendor_ns_id="+vendorid);
			}
